...
## Configuration State
(Populated by /arscontexta:architect, /arscontexta:重新审视)

## Evolution History
(Populated by /arscontexta:重新审视, /arscontexta:architect)
...
Meta-skills (/{DOMAIN:重新审视}, /architect) read from and write to this folder.
